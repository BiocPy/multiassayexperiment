...
module_dir = os.path.join(__location__, "../src/multiassayexperiment")
try:
...
try:
    ...
    version = get_version("multiassayexperiment")
except Exception:
    version = "unknown"
...
html_theme_options = {
    ...
    "source_repository": "https://github.com/biocpy/multiassayexperiment",
    "source_branch": "main",
...
htmlhelp_basename = "multiassayexperiment-doc"
...
latex_documents = [
    ("index", "user_guide.tex", "multiassayexperiment Documentation", "Jayaram Kancherla", "manual")
]
